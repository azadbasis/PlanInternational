...
//        }
        ...
        spinnerDate.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                String date = parentView.getSelectedItem().toString();
    ...
    private void setListItem(String date) {
        if(!date.equalsIgnoreCase("Select your Scheduled Date")){
            ...
            scListCustomAdapter = new SCListCustomAdapter(this, sponsoredChildInfoArrayList, ResponseCode.RESPONSE_CODE_SC_SCHEDULED,myRecyclerForScheduledsc);
