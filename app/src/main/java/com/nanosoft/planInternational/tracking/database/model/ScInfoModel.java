...
public class ScInfoModel {
    ...
    public ScInfoModel(int scInfoProjectId, int scInfoProgramUnit, int scInfoDistrictId, int scInfoUpazillaId, int scInfoCommunityId, int scInfoCommunityWorkerId, int scInfoScNumber, String scInfoScFullName, String scInfoScNameKnownBy, String scInfoScAge, String scInfoScGender,String joining_date, String scInfoScReasonForJoining, String scInfoScReasonForLeaving, String scInfoScLivingInSameHouse, String latitude, String longitude, String photo, String priorityFlag,
