...
public class UpdateProfileActivity extends AppCompatActivity {
    ...
    private RadioGroup radioGroupMMRInjection, radioGroupIfnotWhyNot, radioGroupSeekTreatment,
            radioGroupHealthIssue, radioGroupExperienceHealthIssue, radioGroupSCRecovered, radioGroupNotSeekTreatment;
    private EditText etOthersIssue;
    private String mmrInjection, IfnotWhyNot, SeekTreatment, HealthIssue, SCRecovered, ExperienceHealthIssue, NotSeekTreatment, othersIssue;
...
//COMMITMENT
    ...
    private void SetCheckboxAnswers(String ans) {
        ...
        for (int i = 0; i < c; i++) {
            ...
            if (Collections.frequency(splitted, cb.getText()) > 0) cb.setChecked(true);
...
//        timeTakeGoSchool = SCFavouriteActivityrdo != null ? SCFavouriteActivityrdo.getText().toString() : "";
        ...
        insertToDb("5.7", getCheckBoxAnswers());
