    ...
    public ScInfoModel getScProfile(int id) {
        ...
        while (cursor.moveToNext()) {
            ...
            scInfoModel = new ScInfoModel(scInfoProjectId, scInfoProgramUnit, scInfoDistrictId, scInfoUpazillaId,
                    ...
                    age, scInfoScGender,joining_date, scInfoScReasonForJoining, scInfoScReasonForLeaving,
    ...
    public ArrayList<SCFamilyInfos> getFamilyInfo(int scId) {
        ...
        while (cursor.moveToNext()) {
            ...
            scFamilyInfos = new SCFamilyInfos(id, scId, member_full_name, member_name_known_by, member_relationship,
                    member_occupation, member_gender, member_birth_year, member_is_primary_carer);
...
/*
    ...
    public void saveFamilyInfo(String fullName, String nameKnown, String birth, String gender,
                               String relation, String career, String occu, String reason, int scId) {
        openDataBase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("sc_id", scId);
        contentValues.put("member_full_name", fullName);
        contentValues.put("member_name_known_by", nameKnown);
        contentValues.put("member_relationship", relation);
        contentValues.put("member_occupation", occu);
        contentValues.put("member_gender", gender);
        contentValues.put("member_birth_year", birth);
        contentValues.put("member_is_primary_carer", career);
        contentValues.put("member_reason_for_join", reason);
